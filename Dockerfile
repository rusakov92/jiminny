...
RUN apk --no-cache add php8 php8-fpm php8-json php8-curl \
    ...
    php8-mbstring php8-gd php8-pecl-xdebug php8-iconv \
    php8-simplexml php8-tokenizer php8-pecl-apcu \
    py3-setuptools nginx supervisor curl git bash vim composer
